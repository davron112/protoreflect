...
outdir="."
${PROTOC} "--go_out=paths=source_relative:$outdir" "--gosrcinfo_out=paths=source_relative,debug:$outdir" --experimental_editions -I. *.proto
...
${PROTOC} --descriptor_set_out=./desc_test_editions.protoset --experimental_editions -I. desc_test_editions.proto
